...
--
-- Host: localhost
-- Generation Time: Sep 09, 2012 at 01:59 PM
...
CREATE TABLE IF NOT EXISTS `vs_movies` (
  ...
  `movie_channel_link` mediumtext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vs_series` (
  ...
  `imdb_link` mediumtext NOT NULL,
  `series_release_date` datetime NOT NULL,
  PRIMARY KEY (`series_id`),
  UNIQUE KEY `series_name` (`series_name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5656 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1075793 ;
